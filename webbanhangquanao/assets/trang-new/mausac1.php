...
if (isset($_GET['Mausac'])) { //kiem tra xem co ton tai gia tri cua muasac
    ...
    $mausac = $_GET['Mausac'];
    $sql = "SELECT * FROM sanphamkids , mausackids Where mausackids.Mausacsanpham = '$mausac'
    and sanphamkids.Idsanphamkid = mausackids.Idsanphamkid";
...
<head>
    ...
    <title>Sản phẩm kids <?php echo $data[0]['Mausacsanpham'];?></title>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border rounded-0">
                                    ...
                                    <ul>
                                        <a href="mausac1.php?Mausac=den">
                                            <li>Đen</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=do">
                                            <li>Đỏ</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=trang">
                                            <li>Trắng</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=bac">
                                            <li>Bạc</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=cam">
                                            <li>Cam</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=dodo">
                                            <li>Đỏ Đô</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=hong">
                                            <li>Hồng</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=nau">
                                            <li>Nâu</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=naudat">
                                            <li>Nâu Đất</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=tim">
                                            <li>Tím</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=vang">
                                            <li>Vàng</li>
                                        </a>
                                        <a href="mausac1.php?Mausac=xam">
                                            <li>Xám</li>
                                        </a>
                                        <a href="">
                                            <li>Xám Nhạt</li>
                            ...
                            <div class="tabContainer">
                                    ...
                                    <div class="row articles" style="margin-bottom: 4px;">
                                      ...
                                      foreach ($data as $mausacsanpham) {
                                          ...
                                          <div class="frame show" style="width: 100%;height: 360px;">
                                              <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$mausacsanpham['Idsanphamkid'].'">
                                              ...
                                              <div class="price-box">
                                                  <span class="special-price">
                                                      <span style="color: red;"
                                                          class="woocommerce-Price-amount amount">'.$mausacsanpham['Giasanphamkids'].'<span
                                                              class="woocommerce-Price-currencySymbol">₫</span></span>
                                                  </span>
                                              </div>
                                              <a href="muahang.php?id" style=""><p style="font-size : 12px">'.$mausacsanpham["Tensanphamkids"].'</p></a>
                                          </div>
                                      </div>';
                                      }
                                      ?>
                                ...
                                foreach ($data as $mausacsanphamtab) {
                                    ...
                                    <div class="col-sm-6 col-md-4 item" style="margin-bottom: 4px;">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$mausacsanphamtab['Idsanphamkid'].'">
                                                <img class="anh1" style="width: 15.8em;height: auto;"
                                            ...
                                            <div class="price-box">
                                                <span class="special-price">
                                                    <span style="color: red;"
                                                        class="woocommerce-Price-amount amount">'.$mausacsanphamtab['Giasanphamkids'].'<span
                                                            class="woocommerce-Price-currencySymbol">₫</span></span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$mausacsanphamtab['Idsanphamkid'].'">
                                               '.$mausacsanphamtab['Tensanphamkids'].'
                                            </a> 
                                        </div>
                                    </div>
                                </div>';
