...
$sql1 = "SELECT * FROM sanphamkids ORDER BY Idsanphamkid DESC limit 4";
                            ...
                            <div class="row" style="margin-right: 0px; margin-left: 0px;">
                                <div class="tabContainer">
                                    <div class="row articles"
                                        ...
                                        <?php foreach ($data1 as $sanphamlienquankids) {
                                            echo '<div class="col-sm-3 col-md-3 item" style="margin-bottom: 4px;">
                                            <div class="frame show" style="width: 100%;height: 360px;">
                                                <a style="width : 100% ; height : auto; " class="action" href="thoitrangkids.php">
                                                    <img class="anh1" style="width: 100%;height: auto;"
                                                        src="'.$sanphamlienquankids['Img1'].'" />
                                                    <img class="anh2" style="width: 100%;height: auto;"
                                                        src="'.$sanphamlienquankids['Img2'].'" />
                                                </a>
                                                <div class="price-box">
                                                    <span class="special-price">
                                                        <span style="color: red;"
                                                            class="woocommerce-Price-amount amount">'.$sanphamlienquankids['Giasanphamkids'].'<span
