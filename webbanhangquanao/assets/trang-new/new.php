...
$sql = "SELECT * From sanphamnam where Idsanphamnam > 0 
ORDER BY Idsanphamnam desc limit 3";
$data = select_list($sql);
//print_r($data);exit();
$sql1 = "SELECT * FROM sanphamkids where Idsanphamkids > 0
ORDER BY Idsanphamkid desc limit 3";
        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading" style="color: rgb(0,0,0);">
                    <h2 class="text-info" style="font-size: 30px;color: rgb(0,0,0) !important;"><strong>NEW</strong>
                    </h2>
                </div>
                <div class="content">
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border rounded-0">
                                    ...
                                    <ul>
                                        ...
                                        <a href="mausac.php?Mausac=xamnhat">
                                            <li>Xám Nhạt</li>
                                        </a>
                                        <a href="#">
                                            <li>Xanh Dương</li>
                            ...
                            <div class="tabContainer">
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                    <div class="row articles" style="margin-bottom: 4px;">
                                      <?php
                                      foreach ($data as $sanphamnewnam) {
                                          echo '<div class="col-sm-6 col-md-4 item" style="margin-bottom: 4px;">
                                          <div class="frame show" style="width: 100%;height: 360px;">
                                              <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$sanphamnewnam['Idsanphamnam'].'">
                                                  <img class="anh1" style="width: 15.8em;height: auto;"
                                                      src="'.$sanphamnewnam['Img1'].'" />
                                                  <img class="anh2" style="width: 100%;height: auto;"
                                                      src="'.$sanphamnewnam['Img2'].'" />
                                              </a>
                                              <div class="price-box">
                                                  <span class="special-price">
                                                      <span style="color: red;"
                                                          class="woocommerce-Price-amount amount">'.$sanphamnewnam['Giasanphamnam'].'<span
                                                              class="woocommerce-Price-currencySymbol">₫</span></span>
                                                  </span>
                                              </div>
                                              <a href="muahang.php?Id='.$sanphamnewnam['Idsanphamnam'].'" style=""><p style="font-size : 12px">'.$sanphamnewnam["Tensanphamnam"].'</p></a>
                                          </div>
                                      </div>';
                                      }
                                      ?>
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                <?php
                                foreach ($data as $sanphamnewnamtab) {
                                    echo '<div class="row articles" style="margin-bottom: 4px;">
                                    <div class="col-sm-6 col-md-4 item" style="margin-bottom: 4px;">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$sanphamnewnamtab['Idsanphamnam'].'">
                                                <img class="anh1" style="width: 15.8em;height: auto;"
                                                    src="'.$sanphamnewnamtab['Img1'].'" />
                                                <img class="anh2" style="width: 100%;height: auto;"
                                                    src="'.$sanphamnewnamtab['Img2'].'" />
                                            </a>
                                            <div class="price-box">
                                                <span class="special-price">
                                                    <span style="color: red;"
                                                        class="woocommerce-Price-amount amount">'.$sanphamnewnamtab['Giasanphamnam'].'<span
                                                            class="woocommerce-Price-currencySymbol">₫</span></span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$sanphamnewnamtab['Idsanphamnam'].'">
                                               '.$sanphamnewnamtab['Tensanphamnam'].'
                                            </a> 
                                        </div>
                                    </div>
                                </div>';
