...
$sql = "SELECT * FROM sanphamnam where sale = 'ok'";
$data = select_list($sql);
//print_r($data);exit();
//$sql1 = "SELECT * FROM sanphamkids where sale = 'ok'";
?>
<!DOCTYPE html>
<html>
                    ...
                    <li class="nav-item" role="presentation">
                        <div class="nav-item dropdown" id="2-columnas"
                            style="font-size: 12.8px;height: 35px;padding: 8px;color: rgb(0,0,0);"><a
                                class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="thoitrangkids.php"
        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading" style="color: rgb(0,0,0);">
                    <h2 class="text-info" style="font-size: 30px;color: rgb(0,0,0) !important;"><strong>SALE</strong>
                    </h2>
                </div>
                <div class="content">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="tabContainer">
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                    ...
                                    <?php
                                    foreach ($data as $sanphamsalenam) {
                                        echo '<div class="col-sm-6 col-md-4 item" style="margin-bottom: 4px;">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$sanphamsalenam['Idsanphamnam'].'">
                                                <img class="anh1" style="width: 15.8em;height: auto;" src="'.$sanphamsalenam['Img1'].'" />
                                                <img class="anh2" style="width: 100%;height: auto;" src="'.$sanphamsalenam['Img2'].'" />
                                            </a>
                                            <div class="price-box">
                                                <span class="special-price">
                                                    <span style="color: red;" class="woocommerce-Price-amount amount">'.$sanphamsalenam['Giasanphamnam'].'<span
                                                            class="woocommerce-Price-currencySymbol">₫</span></span>
                                                </span>
                                            </div>
                                            <a href="muahang.php?Id='.$sanphamsalenam['Idsanphamnam'].'" style=""><p style="font-size : 12px">'.$sanphamsalenam["Tensanphamnam"].'</p></a>  
                                        </div>
                                    </div>';
                                    }
                                    ?>
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                <?php
                                foreach ($data as $sanphamsalenamtab) {
                                        ...
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$sanphamsalenam['Idsanphamnam'].'">
                                                <img class="anh1" style="width: 15.8em;height: auto;"
                                                    src="'.$sanphamsalenamtab['Img1'].'" />
                                                <img class="anh2" style="width: 100%;height: auto;"
                                                    src="'.$sanphamsalenamtab['Img2'].'" />
                                            </a>
                                            <div class="price-box">
                                                <span class="special-price">
                                                    <span style="color: red;"
                                                        class="woocommerce-Price-amount amount">'.$sanphamsalenamtab['Giasanphamnam'].'<span
                                                            class="woocommerce-Price-currencySymbol">₫</span></span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$sanphamsalenamtab['Idsanphamnam'].'">
                                               '.$sanphamsalenamtab['Tensanphamnam'].'
                                            </a> 
                                        </div>
                                    </div>
                                </div>';
