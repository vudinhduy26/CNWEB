                ...
                <ul class="nav navbar-nav mx-auto">
                    ...
                    <li class="nav-item" role="presentation">
                        ...
                        <div class="nav-item dropdown" id="1-columna"
                            ...
                            <a data-toggle="dropdown" aria-expanded="false" class="dropdown-toggle" href="thoitrangnam.php"
                    ...
                    <li class="nav-item" role="presentation">
                        <div class="nav-item dropdown" id="2-columnas"
                            style="font-size: 12.8px;height: 35px;padding: 8px;color: rgb(0,0,0);"><a
                                class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="thoitrangkids.html"
                                style="font-size: 11px;color: rgb(12,13,13);"><strong>THỜI TRANG KIDS</strong></a>
        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading" style="color: rgb(0,0,0);">
                    <h2 class="text-info" style="font-size: 30px;color: rgb(0,0,0) !important;"><strong>THỜI TRANG KIDS</strong>
                    </h2>
                    <a href="">Đồ Chơi Trẻ Em</a>
                    <a href="" style="margin-left: 3px ;">Thời Tran Bé Gái</a>
                    <a href="" style="margin-left: 3px ;">Thời Trang Bé Trai</a>
                </div>
                <div class="content">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border rounded-0">
                                    ...
                                    <ul>
                                        <a href="mausac.php1?Mausac=den">
                                            <li>Đen</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=do">
                                            <li>Đỏ</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=trang">
                                            <li>Trắng</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=bac">
                                            <li>Bạc</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=cam">
                                            <li>Cam</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=dodo">
                                            <li>Đỏ Đô</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=hong">
                                            <li>Hồng</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=nau">
                                            <li>Nâu</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=naudat">
                                            <li>Nâu Đất</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=tim">
                                            <li>Tím</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=vang">
                                            <li>Vàng</li>
                                        </a>
                                        <a href="mausac.php1?Mausac=xam">
                                            <li>Xám</li>
                                        </a>
                                        <a href="">
                                            <li>Xám Nhạt</li>
                        ...
                        <div class="col-md-9">
                            <div class="tabContainer">
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                    ...
                                    <?php
                                    foreach ($data as $sanphamkids) {
                                        echo '<div class="col-sm-6 col-md-4 item" style="margin-bottom: 4px;">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang1.php?Id='.$sanphamkids['Idsanphamkid'].'">
                                                <img class="anh1" style="width: 15.8em;height: auto;" src="'.$sanphamkids["Img1"].'" />
                                                <img class="anh2" style="width: 100%;height: auto;" src="'.$sanphamkids["Img2"].'" />
                                            </a>
                                            <div class="price-box">
                                                <span class="special-price">
                                                    <span style="color: red;" class="woocommerce-Price-amount amount">'.$sanphamkids["Giasanphamkids"].'<span
                                                            class="woocommerce-Price-currencySymbol">₫</span></span>
                                                </span>
                                            </div>
                                            <a href="muahang.php1?Id='.$sanphamkids['Idsanphamkid'].'"><p style="font-size : 12px">'.$sanphamkids['Tensanphamkids'].'</p></a> 
                                        </div>
                                    </div>';
                                    }
                                    ?>
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                <?php
                                foreach ($data as $sanphamkidstab) {
                                    echo '<div class="row articles" style="margin-bottom: 4px;">
                                    <div class="col-sm-6 col-md-4 item" style="margin-bottom: 4px;">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang1.php?Id='.$sanphamkidstab['Idsanphamkid'].'">
                                                <img class="anh1" style="width: 15.8em;height: auto;"
                                                    src="'.$sanphamkidstab["Img1"].'" />
                                                <img class="anh2" style="width: 100%;height: auto;"
                                                    src="'.$sanphamkidstab["Img2"].'" />
                                            </a>
                                            <div class="price-box">
                                                <span class="special-price">
                                                    <span style="color: red;"
                                                        class="woocommerce-Price-amount amount">'.$sanphamkidstab["Giasanphamkids"].'<span
                                                            class="woocommerce-Price-currencySymbol">₫</span></span>
                                                </span>
                                            </div>
                                        </div>
