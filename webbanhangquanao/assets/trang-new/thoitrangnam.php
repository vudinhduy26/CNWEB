        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading" style="color: rgb(0,0,0);">
                    <h2 class="text-info" style="font-size: 30px;color: rgb(0,0,0) !important;"><strong>THỜI TRANG NAM</strong>
                    </h2>
                    <a href="">Giày Dép</a>
                    <a href="" style="margin-left: 3px ;">Mũ</a>
                        ...
                        <div class="col-md-9">
                            <div class="tabContainer">
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                    ...
                                    <?php
                                    foreach ($data as $sanphamnam) {
                                        echo '<div class="col-sm-6 col-md-4 item" style="margin-bottom: 4px;">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$sanphamnam['Idsanphamnam'].'">
                                                <img class="anh1" style="width: 15.8em;height: auto;" src="'.$sanphamnam["Img1"].'" />
                                                <img class="anh2" style="width: 100%;height: auto;" src="'.$sanphamnam["Img2"].'" />
                                            </a>
                                            <div class="price-box">
                                                <span class="special-price">
                                                    <span style="color: red;" class="woocommerce-Price-amount amount">'.$sanphamnam["Giasanphamnam"].'<span
                                                            class="woocommerce-Price-currencySymbol">₫</span></span>
                                                </span>
                                            </div>
                                            <a href="muahang.php?Id='.$sanphamnam['Idsanphamnam'].'" style=""><p style="font-size : 12px">'.$sanphamnam["Tensanphamnam"].'</p></a> 
                                        </div>
                                    </div>';
                                    }
                                    ?>
                                ...
                                <div class="tabPanel" style="background-color: white;">
                                <?php
                                foreach ($data as $sanphamnamtab) {
                                    echo '<div class="row articles" style="margin-bottom: 4px;">
                                    <div class="col-sm-6 col-md-4 item" style="margin-bottom: 4px;">
                                        <div class="frame show" style="width: 100%;height: 360px;">
                                            <a style="width : 100% ; height : auto; " class="action" href="muahang.php?Id='.$sanphamnamtab['Idsanphamnam'].'">
                                                <img class="anh1" style="width: 15.8em;height: auto;"
                                                    src="'.$sanphamnamtab["Img1"].'" />
                                                <img class="anh2" style="width: 100%;height: auto;"
                                                    src="'.$sanphamnamtab["Img2"].'" />
                                            </a>
                                            <div class="price-box">
                                                <span class="special-price">
                                                    <span style="color: red;"
                                                        class="woocommerce-Price-amount amount">'.$sanphamnamtab["Giasanphamnam"].'<span
                                                            class="woocommerce-Price-currencySymbol">₫</span></span>
                                                </span>
                                            </div>
                                        </div>
