    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <form action="xulydangbai.php" method="post" class="bootstrap-form-with-validation" enctype="multipart/form-data">
                    <h2 class="text-center">ĐĂNG BÀI</h2>
                    <div class="form-group"><label for="text-input">Tiêu đề bài viết</label><input type="text" class="form-control" id="text-input" name="tieudebaiviet" /></div>
                    <div class="form-group"><label for="textarea-input">Nội dung bài viết</label><textarea class="form-control" id="textarea-input" name="noidungbaiviet"></textarea></div>
                    <div class="form-group"><label for="text-input">Ảnh 1</label><input type="file" class="form-control" id="text-input" name="anhdang1" /></div>
                    <div class="form-group"><label for="text-input">Ảnh 2</label><input type="file" class="form-control" id="text-input" name="anhdang2" /></div>
