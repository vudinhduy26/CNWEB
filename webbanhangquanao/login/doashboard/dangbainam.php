...
$sql = "SELECT loaisanphamnam FROM sanphamnam ";
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <form action="xulydangbainam.php" method="post" class="bootstrap-form-with-validation" enctype="multipart/form-data">
                    <h2 class="text-center">ĐĂNG BÀI NAM</h2>
                    ...
                    <!--<?php
                    //foreach ($data as $loaisanpham) { ?>
                        <option value="<?php echo $loaisanpham['loaisanphamnam'];?>"><?php echo $loaisanpham['loaisanphamnam']?></option>
                    <?php
                    //}
                    ?>-->
