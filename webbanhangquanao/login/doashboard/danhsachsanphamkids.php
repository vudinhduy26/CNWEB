...
$sql = "SELECT Idsanphamkid , Tensanphamkids , Giasanphamkids from sanphamkids";
//print_r($sql);exit();
...
<head>
    ...
    <title>DANH SÁCH THỜI TRANG KIDS</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>THỜI TRANG KIDS</span></div>
                </a>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3"
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        data-toggle="dropdown" aria-expanded="false" href="#"><span
                                            class="d-none d-lg-inline mr-2 text-gray-600 small"><?php echo $_SESSION['login_user']?></span><img
                                    ...
                                    <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                                        ...
                                        <a class="dropdown-item" role="presentation" href="#"><i
                                            ...
                                            log</a>
                                        <div class="dropdown-divider"></div><a onclick="logout()" class="dropdown-item"
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid"
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        echo "<tr>
                                                <td>".$sanphamhienthi["Idsanphamkid"]."</td>
                                                <td>".$sanphamhienthi["Tensanphamkids"]."</td>
                                                <td>".$sanphamhienthi["Giasanphamkids"]."</td>
                                              </tr>";
                                    }
