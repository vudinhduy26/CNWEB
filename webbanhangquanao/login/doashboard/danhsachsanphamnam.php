...
$sql = "SELECT Idsanphamnam , Tensanphamnam , Giasanphamnam from sanphamnam";
//print_r($sql);exit();
$sanpham = select_list($sql);
//print_r($sanpham);exit();
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>DANH SÁCH THỜI TRANG NAM</title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>THỜI TRANG NAM</span></div>
                </a>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">DANH SÁCH SẢN PHẨM NAM</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 text-nowrap">
                                <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"><label>Hiển Thị&nbsp;<select class="form-control form-control-sm custom-select custom-select-sm"><option value="10" selected="">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select>&nbsp;</label></div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Tên Sản Phẩm Nam</th>
                                        <th>Giá</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <!--<tr>
                                        <td><img class="rounded-circle mr-2" width="30" height="30" src="">Airi Satou</td>
                                        <td>Accountant</td>
                                        <td>Tokyo</td>
                                        <td>33</td>
                                    </tr>-->
                                    <?php foreach($sanpham as $sanphamhienthi){
                                        echo "<tr>
                                                <td>".$sanphamhienthi["Idsanphamnam"]."</td>
                                                <td>".$sanphamhienthi["Tensanphamnam"]."</td>
                                                <td>".$sanphamhienthi["Giasanphamnam"]."</td>
                                              </tr>";
                                    }
