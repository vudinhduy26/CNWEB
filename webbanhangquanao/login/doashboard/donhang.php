                            ...
                            <table class="table my-0" id="dataTable">
                                ...
                                <!--<tr>
                                    ...
                                    <?php foreach($sanpham as $sanphamhienthi){
                                        echo "<tr>
                                                <td>".$sanphamhienthi["id"]."</td>
                                                <td>".$sanphamhienthi["Tensanpham"]."</td>
                                                <td>".$sanphamhienthi["Soluong"]."</td>
                                                <td>".$sanphamhienthi["Tennguoimua"]."</td>
                                                <td>".$sanphamhienthi["Sodt"]."</td>
                                                <td>".$sanphamhienthi["Diachi"]."</td>
                                              </tr>";
                                    }
