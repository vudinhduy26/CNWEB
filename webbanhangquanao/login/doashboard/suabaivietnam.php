    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <form action="suadangbainam.php" method="post" class="bootstrap-form-with-validation" enctype="multipart/form-data">
                    <h2 class="text-center">SỬA BÀI NAM</h2>
                    <div class="form-group"><label for="text-input">Id sản phẩm</label><input type="text" class="form-control" id="text-input" name="idsanphamnam" /></div>
                    <div class="form-group"><label for="text-input">Tên sản phẩm</label><input type="text" class="form-control" id="text-input" name="tensanphamnam" /></div>
                    <div class="form-group"><label for="text-input">Ảnh 1</label><input type="file" class="form-control" id="text-input" name="anhnam1" /></div>
                    <div class="form-group"><label for="text-input">Ảnh 2</label><input type="file" class="form-control" id="text-input" name="anhnam2" /></div>
                    <div class="form-group"><label for="text-input">Tiêu đề</label><input type="text" class="form-control" id="text-input" name="tieude" /></div>
                    <div class="form-group"><label for="textarea-input">Nội dung bài viết</label><textarea class="form-control" id="textarea-input" name="noidungsanphamnam"></textarea></div>
                    <div class="form-group"><label for="text-input">Giá sản phẩm</label><input type="text" class="form-control" id="text-input" name="giasanphamnam" /></div>
                    <div class="form-group"><label for="text-input">Mẫu Loại : </label>
                    <select name="loaisanphamnam" id="cars">
                    ...
                    <div class="form-group">
                         Sale
                        <div class="form-check"><input type="radio" class="form-check-input" name="radio-group" id="formCheck-6" /><label class="form-check-label" for="formCheck-6">Ok</label></div>
                        <div class="form-check"><input type="radio" class="form-check-input" name="radio-group" checked id="formCheck-7" /><label class="form-check-label" for="formCheck-7">No</label></div>
                    </div>
                    <div class="form-group"><button class="btn btn-primary" type="submit">SỬA</button></div>
                </form>
            </div>
        </div>
