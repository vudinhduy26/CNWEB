...
$idsanphamkid = isset($_REQUEST['idsanphamkid']) ? $_REQUEST['idsanphamkid'] : "";
$tensanphamkid = isset($_REQUEST['tensanphamkid']) ? $_REQUEST['tensanphamkid'] : "";
$anhkid1 = upload_file_by_name("anhkid1");
$anhkid2 = upload_file_by_name("anhkid2");
$tieudekid = isset($_REQUEST['tieude']) ? $_REQUEST['tieude'] : "";
$noidungsanphamkid = isset($_REQUEST['noidungsanphamkids']) ? $_REQUEST['noidungsanphamkids'] : "";
$giasanphamkid = isset($_REQUEST['giasanphamkids']) ? $_REQUEST['giasanphamkids'] : "";
$loaisanphamkid = isset($_REQUEST['loaisanphamkids']) ? $_REQUEST['loaisanphamkids'] : "";
$gioitinhkids = isset($_REQUEST['gioitinhkids']) ? $_REQUEST['gioitinhkids'] : "";
$sale = isset($_REQUEST['sale']) ? $_REQUEST['sale'] : "";

$data = array();
$data["Tensanphamkids"] = $tensanphamkid;
$data["Img1"] = $anhkid1;
$data["Img2"] = $anhkid2;
$data["Tieude"] = $tieudekid;
$data["Noidung"] = $noidungsanphamkid;
$data["Giasanphamkids"] = $giasanphamkid;
$data["loaisanphamkids"] = $loaisanphamkid;
$data["sale"] = $sale;
$cond = "Idsanphamkid={$idsanphamkid}";
$tbl = "sanphamkids";
...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <h2 class="text-center">SỬA BÀI ĐĂNG KIDS</h2>
              <p class="text-center">SẢN PHẨM CỦA BẠN ĐÃ ĐƯỢC SỬA THÀNH CÔNG</p>
            </div>
        </div>
