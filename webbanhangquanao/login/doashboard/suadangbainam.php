...
$idsanpham = isset($_REQUEST['idsanphamnam']) ? $_REQUEST['idsanphamnam'] : "";
$tensanphamnam = isset($_REQUEST['tensanphamnam']) ? $_REQUEST['tensanphamnam'] : "";
$anhnam1 = upload_file_by_name("anhnam1");
$anhnam2 = upload_file_by_name("anhnam2");
$tieudenam = isset($_REQUEST['tieude']) ? $_REQUEST['tieude'] : "";
$noidungsanphamnam = isset($_REQUEST['noidungsanphamnam']) ? $_REQUEST['noidungsanphamnam'] : "";
$giasanphamnam = isset($_REQUEST['giasanphamnam']) ? $_REQUEST['giasanphamnam'] : "";
$loaisanphamnam = isset($_REQUEST['loaisanphamnam']) ? $_REQUEST['loaisanphamnam'] : "";

$data = array();
$data["Tensanphamnam"] = $tensanphamnam;
$data["Img1"] = $anhnam1;
$data["Img2"] = $anhnam2;
$data["Tieude"] = $tieudenam;
$data["Noidung"] = $noidungsanphamnam;
$data["Giasanphamnam"] = $giasanphamnam;
$data["loaisanphamnam"] = $loaisanphamnam;
$cond = "Idsanphamnam={$idsanpham}";
$tbl = "sanphamnam";
...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <h2 class="text-center">SỬA BÀI ĐĂNG NAM</h2>
