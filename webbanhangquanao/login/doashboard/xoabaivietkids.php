    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <form action="xoakids.php" method="post" class="bootstrap-form-with-validation" enctype="multipart/form-data">
                    <h2 class="text-center">XÓA SẢN PHẨM KIDS</h2>
                    <div class="form-group"><label for="text-input">Id sản phẩm</label><input type="text" class="form-control" id="text-input" name="idsanphamkid" /></div>

                    <!--<div class="form-group"><label for="file-input">File Input</label><input type="file" id="file-input" name="file-input" /></div>-->

                    <div class="form-group"><button class="btn btn-primary" type="submit">XÓA</button></div>
                </form>
            </div>
        </div>
