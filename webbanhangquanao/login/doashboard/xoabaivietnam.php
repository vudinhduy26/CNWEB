    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <form action="xoanam.php" method="post" class="bootstrap-form-with-validation" enctype="multipart/form-data">
                    <h2 class="text-center">XÓA SẢN PHẨM NAM</h2>
