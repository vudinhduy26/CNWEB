...
$idsanphamkid = $_POST['idsanphamkid'];
...
if (isset($data1['Idsanphamkid'])) {
    ...
    $false = "SẢN PHẦM NÀY CHƯA CÓ TRONG KHO DANH SÁCH";
}
?>
...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <h2 class="text-center">XÓA BÀI ĐĂNG KIDS</h2>
              <p class="text-center"><?php if (isset($data1['Idsanphamkid'])) {
                  echo $success;
              }else {
                  echo $false;
              }?></p>
